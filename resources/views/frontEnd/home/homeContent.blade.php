...
@section('meta')
    ...
    <meta property="og:description"
          content="Bijes in Haarlem, Bloemendaal of omgeving? Vind gemakkelijk via Omegabijles de bijlesgever die bij je past! â�� Bijles aan huis. Voor VMBO, HAVO, VWO en gymnasium. â��We helpen met de stof en geven persoonlijke tips mee. "/>
    <meta name="Language" content="nederlands"/>
    <meta http-equiv="content-type" content="text/html; charset=utf-8"/>

    <meta name="description"
          content="Gemakkelijk bijles aan huis vinden in regio Haarlem, Bloemendaal of omgeving? Vind via Omegabijles de bijlesgever die bij je past. En ga gestructureerd aan de slag! â�� Bijles aan huis. â�� Voor VMBO, HAVO, VWO en gymnasium. We helpen met de stof en geven persoonlijke tips mee. ">

    <meta name="keywords"
          content="bijles, begeleiding, haarlem, bloemendaal, overveen, ijmuiden, velsen, santpoort, beverwijk, heemskerk, aan huis, vmbo, havo, vwo, gymnasium, omegabijles, wiskunde, scheikunde, natuurkunde, nederlands, latijn, grieks, duits, frans, engels, aardrijskunde, geschiedenis, biologie"/>
...
@section('content')
    ...
    <header class="container-fluid main-header height-md-auto pt-70">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ml-auto">
                    ...
                    <a class="nav-item nav-link"
                       ...
                       style="color: #020401 !important"
                       @endif
                       href="{{ url('/hoehetwerkt') }}">Hoe het werkt
                    </a>
                    <a class="nav-item nav-link"
                       @if(request()->is('/overons'))
                       style="color: #020401 !important"
                       @endif
                       href="{{ url('/overons') }}">Over ons
                    </a>
                    <a class="nav-item nav-link"
        ...
        <div class="header-content">
            ...
            <span class="jontronar_lb">
                ...
                <br>
                <br>
                Beoordeeld met een 8,2 (5/5 sterren) op Trustpilot!
            </p>
        </div>
    </header>
    ...
    <section id="filter">
        <div class="filter cta-box container">
            <div class="row">
                ...
                <div class="col-md-1"></div>
                <div class="col-md-4 no-pading text-center">
                    <a class="btn my-btn" href="{{ route('contact') }}">Bijles aanvragen</a>
                </div>
                <div class="col-md-1"></div>
            </div>
    ...
    <section class="text" id="first-text">
        <div class="container content">
            ...
            <p class="pt-3">Soms heb je een vak waarbij je de stof net niet goed snapt of waarbij de toetsen of het
                huiswerk <b>ontzettend moeilijk</b> zijn. Je haalt <b>lagere cijfers</b> terwijl jij en je ouders het
                gevoel hebben dat er meer in zit. Dat maakt het vak vaak ook minder leuk, je raakt er <b>gestresst en
                    gefrustreerd</b> van en je motivatie wordt minder waardoor je nog lagere cijfers haalt dan je zou
                kunnen. Zonde! Ook kan dit thuis vervelende discussies opleveren. Herkenbaar? <br>
                <br>Waar het probleem ook ligt, met onze bijlessen aan huis helpen wij je graag optimaal vooruit. Wij
                vinden het een must dat we je zelfkennis en vaardigheden meegeven voor je algemene leerproces, zodat je
                echt wat aan onze bijlessen hebt - ook voor later. We helpen je met de leerstof, bieden je overzicht en
                geven je heel nuttige persoonlijke tips mee, zodat je:<br>
                <br>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <br>
                    <center>
                        <img src="{{ URL::to('public/jatemp/temp/imgjs/iconha1.jpg ') }}"
                             alt="Vooruit in kennis en zelfvertrouwen" width="40%">
                        <center>
                ...
                <div class="col-md-4">
                    ...
                    <br>
                    <center>
                        <img src="{{ URL::to('public/jatemp/temp/imgjs/iconha2.jpg') }}"
                             alt="Meer overzicht van de stof" width="40%">
                    </center>
                    <div class="text_botom">
                        <div>
                ...
                <div class="col-md-4">
                    ...
                    <br>
                    <center>
                        <img src="{{ URL::to('public/jatemp/temp/imgjs/iconha3.jpg') }}"
                             alt="Beter voorbereid voor de volgende toets (en daarna)" width="40%">
                    </center>
                    <div class="text_botom">
                        <div>
                            <p class="top-text"><b>Beter voorbereid en minder stress voor de volgende toets (en
                                    daarna)</b></p>
                        </div>
                    </div>
                </div>
                <p class="pt-3" style=!important;">Ben jij klaar om aan de slag te gaan? Dien een bijlesaanvraag in of
                    vind via de zoekmachine hierboven de bijlesgever die bij jou past en zie dat je vooruit gaat!</p>
            </div>
    </section>
    <section id="red-post">
        <div class="container">
            <div class="row">
                <div class="col-md-9 col-sm-12">
                    <div class="red-post-content">
                        ...
                        <p class="pt-3 ml-3" style="color: #fff!important;">Of je nu moeite hebt met Engels of wiskunde
                            of misschien wel Latijn of economie, bij Omegabijles vind je de bijlesgever die bij je past.
                            Dien een bijlesaanvraag in zodat wij de passende bijlesgever vinden, of neem zelf contact op
                            met een bijlesgever naar keuze via onze zoekmachine. Al binnen drie dagen kun je aan de
                            slag.
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7 pt-5">
                    ...
                    <p>Al onze bijlesgevers zijn leerlingen of oud-leerlingen (studenten) die bekend zijn met jouw
                        school.</p>
                    <ul>
                        <li>
                            <span><i class="fas fa-check"></i></span>
                            We weten wat bepaalde docenten willen zien op je toetsen
                        </li>
                        <li>
                            <span><i class="fas fa-check"></i></span>
                            Onze bijlesgevers hebben precies dezelfde stof ook al een keer gehad, dus we weten waar de
                            moeilijkheden liggen
                        </li>
                        <li>
                            <span><i class="fas fa-check"></i></span>
                            Jouw docent en ouders krijgen regelmatige updates van hoe het met de bijlessen gaat
                        </li>
                    </ul>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <span class="line-c"></span>
                    <p>Al onze bijlesgevers zijn persoonlijk geselecteerd en hebben een uitgebreide training gehad. Onze
                        bijlesgevers:</p>
                    <ul>
                        <li>
                            <span><i class="fas fa-check"></i></span>
                            Hebben minimaal een 7,5 voor de vakken waar ze bijles in geven
                        </li>
                        <li>
                            <span><i class="fas fa-check"></i></span>
                            Weten hoe ze jou vooruit kunnen helpen in oa. motivatie, concentratie en plannen
                        </li>
                        <li>
                            <span><i class="fas fa-check"></i></span>
                            Zijn ook geselecteerd op enthousiasme en didactische vaardigheden (bijv. hoe ze uitleggen)
                        </li>
                    </ul>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <span class="line-c"></span>
                    <p>Onze bijlesgevers houden een handige structuur aan v&oacute;&oacute;r, tijdens en na de
                        bijlessen. Zo maximaliseren we jouw leerproces.</p>
                    <ul>
                        <li>
                            <span><i class="fas fa-check"></i></span>
                            We werken met een intakeformulier en een persoonlijk leerplan
                        </li>
                        <li>
                            <span><i class="fas fa-check"></i></span>
                            We evalueren regelmatig. Zo weet je precies wat je hebt geleerd en waar jouw bijlesgever je
                            nog bij kan helpen
                        </li>
                        <li>
                            <span><i class="fas fa-check"></i></span>
                            Je krijgt tips die specifiek afgestemd zijn op waar jij moeite mee hebt - erg handig voor
                            later!
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <ul>
                        <li>
                            <span><i class="fas fa-check"></i></span>
                            Betaal slechts &euro;15,- of &euro;21,- per bijlesuur, van respectievelijk een leerling of
                            een student (oud-leerling)
                        </li>
                        <li>
                            <span><i class="fas fa-check"></i></span>
                            Klikt het onverhoopt niet tijdens de eerste les? Dan brengen wij de les niet in rekening
                        </li>
                        <li>
                            <span><i class="fas fa-check"></i></span>
                            Maandelijks ontvangt u achteraf een factuur (via Whatsapp of per email) die u veilig via
                            iDeal kunt voldoen
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-8">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="test-content">
                                    ...
                                    <p>R. heeft altijd zin om met Milena aan de slag te gaan. Milena helpt R. zelf het
                                        antwoord te vinden, geeft overzicht en leert R. de puntjes op de i te
                                        zetten. </p>
                            ...
                            <div class="carousel-item">
                                <div class="test-content">
                                    ...
                                    <span class="line"></span>
                                    <p class="my-3">Zij gingen je al voor</p>
                                    <p>Ik vind het altijd heel erg fijn om mijn Latijn en Grieks huiswerk samen te
                                        maken. Door de goede uitleg haal ik betere cijfers.</p>
                    ...
                    <div class="trustpilot-widget" data-locale="nl-NL" data-template-id="5419b6a8b0d04a076446a9ad"
                         data-businessunit-id="5b8d0789cc02dd00010b5926" data-style-height="24px"
                    ...
                    <p class="my-3" style="text-align: center;">
                        <a target="_blank" href="https://nl.trustpilot.com/review/omegabijles.nl">Bekijk hier alle
                            reviews
                        </a>
                    </p>
                </div>
    ...
    <div style="background-color: #F7FAFC;">
        <section class="test my-2" id="last-test">
            <div class="container content">
                ...
                <p>Omegabijles is in februari 2017 opgericht om leerlingen echt optimaal vooruit te helpen door ze te
                    verbinden met bijlesgevers die ondersteuning bieden waar nodig. Het streven is de leerlingen niet
                    alleen te helpen tot de toets maar juist ook tips mee te geven over hoe ze hun algemene leerproces
                    kunnen verbeteren. Principes uit de pedagogiek en neurowetenschappen vormen de basis van
                    Omegabijles. OMEGA staat voor “Opnemen”, “Monitoren”, “Efficiënt werken”, “Groeien” en “Antwoord
                    geven”.</p>
            </div>
        </section>
    </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="openSearch" tabindex="-1" role="dialog" aria-labelledby="openSearchLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="openSearchLabel">Zoeken</h5>
