...
<head>
  ...
  <title>Omegabijiles | Log in</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('public/adminn/plugins/iCheck/square/blue.css')}}">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to Enter</p>
<style type="text/css">
  .help-block{
    color:red;
  }
...
<!-- iCheck -->
<script src="{{ asset('public/adminn/plugins/iCheck/icheck.min.js')}}"></script>
<script>
  $(function () {
    $('input').iCheck({
