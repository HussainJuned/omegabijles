...
<link rel="stylesheet" href="{{ asset('public/adminn/style.css') }}">
 <header  class="main-header">
    <!-- Logo -->
    <a style="background-color: #4391F2;" href="#" class="logo">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset('public/adminn/dist/img/user2-160x160.jpg' ) }}" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{ url('/admin/changepassword') }}" class="btn btn-default btn-flat">Wijzig wachtwoord</a>
                </div>
                <div class="pull-right">
                  <a href="{{ url('/admin/logout') }}" class="btn btn-default btn-flat">Afmelden</a>
                </div>
              </li>
            </ul>
          </li>
