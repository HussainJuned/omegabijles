		 ...
		 <div class="row">
			<div class="col-md-5 col-sm-12">
				<div class="left_section text_wtite">	
					<h2>Op zoek naar bijles aan huis in Haarlem?</h2>
						<p class="text_white">Wij geven persoonlijk afgestemde bijlessen aan huis en zien onze leerlingen groeien in (zelf-)kennis en vaardigheden! Vind ook via Omegabijles gemakkelijk de bijlesgever die bij uw kind past:</p>
						
						<div class="button">
							<button type="button" class="btn btn-danger" onclick="window.location='{{ url('/search-tutor') }}'">Ik zoke een bijlesgever </button>
						</div>
				</div>
			</div>
	...
	<div class="container">
		...
		<div class="grid_section">
			<div class="row">
				<div class="col-sm-4">
					<div class="option">
						<i class="fa fa-check" aria-hidden="true"></i><span>Bijles ann huis </span>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="option">
						<i class="fa fa-check" aria-hidden="true"></i><span>Persoonalijk afgestemd</span>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="option">
						<i class="fa fa-check" aria-hidden="true"></i> <span>Geselecteerde bijlesgever</span>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="media">
					 ...
					 <img class="align-self-end mr-3" src="{{ asset('/public/frontEnd/harleem/images/01.jpg') }}" alt="Generic placeholder image">
					</div>
				</div>
				<div class="col-sm-4">
					<div class="media">
				...
				<div class="col-sm-4">
					<div class="media">
					 ...
					 <img class="align-self-end mr-3" src="{{ asset('/public/frontEnd/harleem/images/03.jpg') }}" alt="Generic placeholder image">
					</div>
				</div>
			</div>
			<div class="review">
		...
		<div class="bg_color section_link">
			...
			<div class="">
				<div class="row">
					<div class="col-md-12">
						<div class="link">
							<button type="button" class="btn btn-light" onclick="goToSearch('Aardrijksunde')">Aardrijksunde</button>
						...
						<div class="right_side">
							<div class="accordion" id="accordionExample">
							  ...
							  <div class="card">
								...
								<div id="collapseFour" class="collapse" aria-labelledby="headingEleven" data-parent="#accordionExample">
								  <div class="card-body">
									Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid.
								  </div>
								</div>
							  ...
							  <div class="card">
								...
								<div id="collapseFive" class="collapse" aria-labelledby="headingTwelve" data-parent="#accordionExample">
								  <div class="card-body">
									Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid.
								  </div>
								</div>
...
<section class="footer_section">
	<div class="container">
			<div class="last_logo_text">
				<h3><a href="#">Omegabijles</a></h3>
			</div>
			<div class="grid_section">
				<!-- *// footer_link START *// -->
				<div class="row">
					...
					<div class="col-md-3 col-sm-4 col-12">
						<ul class="footer_ul">
							<li class="text_white"><h6><strong>Vaak gezocht:</h6></strong></li>
				...
				<div class="row  mt-3 mag__loft">
					<div class="col-md-9">
						<p class="my-3" style="color: #FFF !important;">
							<span class="m-2">&copy; Omegabijles 2018</span> | 
								<a target="_blank" href="#" class="m-2">Algemene voorwaarden</a> | 
								<a target="_blank" class="m-2" href="#">Privacy- en-cookiesstatement</a>
						</p>
					</div>
					<div class="col-md-3">
						<h6 class="mt-3 text_white text-center">Optimaal vooruit.</h6>
					</div>
				</div>
			</div>
	</div>
...
function goToSearch(value) {
   window.location = '{{ url("/haarlem")}}/' + value
}
</script>
</body>
</html>	